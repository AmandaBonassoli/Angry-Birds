...
public class AngryBirds {
	    ...
	    static JLabel fundo = new JLabel (new ImageIcon("imagem\\fundo2.png")); //CRIA A IMAGEM DE PLANO DE FUNDO
	    static JLabel red = new JLabel (new ImageIcon("imagem\\red.png")); // CRIA A IMAGEM DO PASSARINHO RED
	    static JLabel estilingue = new JLabel (new ImageIcon("imagem\\estilingue3.png"));; // CRIA A IMAGEM DO ESTILINGUE
