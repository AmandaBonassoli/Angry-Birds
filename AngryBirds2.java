...
public class AngryBirds2 {
	...
	static JFrame telamenu1 = new JFrame("Forca de lancaamento");
	static JFrame telamenu2 = new JFrame("Angulo de lancamento");
	...
	static JLabel angulo1 = wordLabel("0�");
	static JLabel angulo2 = wordLabel("90�");
	...
	static JMenuItem informacao = new JMenuItem("INFORMACOES");
	...
	static JButton seguinte = new JButton("PROXIMO");
	...
	static void Componentes_Tela() {
		...
		ajuda.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "TECLE ENTER PARA LANCAR O PASSARINHO RED");
			}
		});
	...
	static void tutorial_game(){
		...
		JOptionPane.showMessageDialog(null, "BEM-VINDO AO TUTORIAL DO JOGO\n"
				...
				+ "VOCE PRECISA AJUDAR O RED A ATINGIR OS PORCOS E RESGATAR OS OVOS");
	...
	static void tutorial_game2(){
		...
		ok.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "O TURORIAL TERMINA AQUI\n"
						+ "APOS ISSO, O PASSARO SERA LANCADO DE ACORDO COM A FORCA E O ANGULO DESEJADO\n"
